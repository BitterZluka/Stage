...
`CatalogChallenge` includes the public creator token ID when provisioned, plus
the participation and winner reward amounts as base-10 strings in the token's
smallest unit.
