  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl">
        <span className="font-display mb-4 inline-block rounded-full border-2 border-black bg-white px-3 py-1 text-xs font-bold tracking-wide">
          DISCOVER CREATOR CHALLENGES
        </span>
        <h1 className="font-display mb-4 text-3xl leading-[1.1] font-bold sm:text-4xl lg:text-5xl">
          Find your next <span className="text-holo-gradient">challenge</span>
        </h1>
